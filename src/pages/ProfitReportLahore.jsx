...
export default function ProfitReportLahore() {
  ...
  // Challan profit ledger (from challans with Lahore bilties)
  ...
  const handleDeleteReceived = async (id) => {
    await supabase.from('profit_received_lahore').delete().eq('id', id);
    fetchReceived();
  };
    ...
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '6px', flexWrap: 'wrap', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <h1 className="page-title" style={{ marginBottom: 0 }}>A/C Receivable — Lahore</h1>
        </div>
      </div>
      <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginBottom: '20px' }}>
        Track Lahore branch challan A/C receivable and received payments.
      </p>
